...
image_panda_happy = "panda_happy.png"


def get_normal_panda_image(file_panda):
    pygame.image.load("panda.jpg")

class Panda:
    # створити панду з такими параметрами: картинка панди, координати x та y, ім'я панди
    def __init__(self, file_panda, file_panda_happy, start_x, start_y, panda_name):
        self.image_normal = pygame.image.load(file_panda)              #   завантажуємо картинку в пам'ять програми
        self.image_happy = pygame.image.load(file_panda_happy)  #   завантажуємо картинку в пам'ять програми
        self.image = self.image_normal                  #   прямокутник навколо картинки
    ...
    def change_skin_if_another_panda_is_near(self, other_panda):
        ...
        if is_near:
            ...
            self.image = self.image_happy       # якщо поряд інша панда, то використати картинку веселої панди
        else:
            self.image = self.image_normal      # інакше використати панди в космосі
...
panda1 = Panda('panda.jpg', 'panda_happy.png', 100, 100, "Перша панда")
panda2 = Panda('panda.jpg', 'panda_happy.png',  100, 100, "Друга панда")
